...
class Tarea {
  ...
  Tarea({
    ...
    this.descripcion =
        '', // La descripción es opcional y por defecto es una cadena vacía.
    ...
    this.provincia = 'Todas las provincias',
  });
  ...
  String toJson() {
    ...
    return '$titulo|$descripcion|${estaCompletada ? 1 : 0}|$categoria|$provincia';
  }
  ...
  factory Tarea.fromJson(String json) {
    ...
    return Tarea(
      ...
      descripcion: parts.length > 1
          ? parts[1]
          : '', // El segundo elemento es la descripción (si existe).
      estaCompletada: parts.length > 2
          ? parts[2] == '1'
          : false, // El tercer elemento indica si está completada.
      categoria: parts.length > 3
          ? parts[3]
          : 'General', // El cuarto elemento es la categoría (si existe).
      provincia: parts.length > 3
          ? parts[4]
          : 'Todas las provincias', // El quinto elemento es la provincia (si existe).
    );
  }
}
